...
| tapToHideKeyboard              | 点击LargeList是否收起键盘                                                                                                                                                                                                             | boolean                                                                                                       | no       | Android/iOS | yes（依赖2.x基线的springscroll） |
...
| dragToHideKeyboard             | 滑动屏幕时是否隐藏键盘                                                                                                                                                                                                                | boolean                                                                                                       | no       | Android/iOS | yes（依赖3.x基线的springscroll） |
